...
export const DEFAULT_META: PageMeta = {
  title: 'PepeDex',
  description:
    'The frenliest AMM on Ethereum Mainnet!.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for PepeDex exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for PepeDex exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for PepeDex exchanges.' },
