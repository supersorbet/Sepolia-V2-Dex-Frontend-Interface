...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'COPE card' },
    { src: 'green', alt: 'Green COPE card with up arrow' },
    { src: 'red', alt: 'Red Cope card with down arrow' },
    { src: 'top-right', alt: 'COPE card' },
  ],
}
