...
const supportedChainId = [ChainId.GOERLI, ChainId.BSC, ChainId.GOERLI_ARBI, ChainId.BASED]
export const bCakeSupportedChainId = [ChainId.BSC, ChainId.GOERLI_ARBI, ChainId.BASED]
