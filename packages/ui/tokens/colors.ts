...
export const darkColors = {
  ...
  ...additionalColors,
  secondary: '#00EEFF',
  secondary80: '#00EEFF80',
  background: '#000000',
  backgroundDisabled: '#1a1a1a',
  backgroundAlt: '#0F0F0F',
  backgroundAlt2: 'rgba(15, 15, 15, 0.7)',
  cardBorder: '#00EEFF',
  contrast: '#FFFFFF',
  dropdown: '#121212',
  dropdownDeep: '#090909',
  ...
  textSubtle: '#00EEFF',
  disabled: '#3a3a3a',
  gradientBubblegum: 'linear-gradient(139.73deg, #000000 0%, #101010 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #101010 0%, #000000 100%)',
  gradientCardHeader: 'linear-gradient(166.77deg, #0a0a0a 0%, #151515 100%)',
  gradientBlue: 'linear-gradient(180deg, #00EEFF 0%, #0099CC 100%)',
  gradientViolet: 'linear-gradient(180deg, #00EEFF 0%, #0099CC 100%)',
  gradientVioletAlt: 'linear-gradient(180deg, #00EEFF 0%, #006699 100%)',
  gradientGold: 'linear-gradient(180deg, #00EEFF 0%, #0099CC 100%)',
  gradientBold: 'linear-gradient(#00EEFF, #006699)',
}
